...
use pi_bevy_render_plugin::{PiRenderOptions, PiRenderPlugin, PlayState, Records, RECORD_D3_COMMAND};
        ...
        match event {
            ...
            Event::Resumed => {
                ...
                
                {
                    ...
                    use pi_export_base::asset::sys_screen_with_postprocess;
                    use pi_export_base::record::Records3D;
                    use pi_export_base::export::sys_vertex_buffer;
                    ...
                    app.add_systems(
                        pi_world::schedule::Update,
                        p3d_errors.in_set(pi_scene_shell::prelude::ERunStageChap::StateCheck)
                    );
                    app.add_systems(
...
pub fn p3d_errors(
    mut error_record: SingleResMut<ResErrorRecord>
) {
    error_record.1 = true;
    let mut idx = 0;
    error_record.0.drain(..).for_each(|v| {
        // log::error!("Err: {:?}", v);
    });
}
