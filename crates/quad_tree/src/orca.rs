...
use pi_orca::rvos_imulator::RVOSimulator as RVOSimulatorInner;
...
impl RVOSimulator {
    ...
    */
    ...
    #[pi_js_export]
    pub fn get_agent_agent_neighbor(&self, agent_no: f64, neighbor_no: u32) -> Option<f64> {
        self.0.get_agent_agent_neighbor(agent_no, neighbor_no as usize)
    }

    #[pi_js_export]
    pub fn get_agent_max_neighbors(&self, agent_no: f64) -> Option<u32> {
        self.0.get_agent_max_neighbors(agent_no).map(|v| v as u32)
    }
    ...
    #[pi_js_export]
    pub fn get_agent_num_agent_neighbors(&self, agent_no: f64) -> Option<u32> {
        self.0.get_agent_num_agent_neighbors(agent_no).map(|v| v as u32)
    }

    #[pi_js_export]
    pub fn get_agent_num_obstacle_neighbors(&self, agent_no: f64) -> Option<u32> {
        self.0.get_agent_num_obstacle_neighbors(agent_no).map(|v| v as u32)
    }

    pub fn get_agent_num_orcalines(&self, agent_no: f64) -> Option<u32> {
        self.0.get_agent_num_orcalines(agent_no).map(|v| v as u32)
    }
    ...
    #[pi_js_export]
    pub fn get_agent_position(&self, agent_no: f64) -> Option<Vec<f64>> {
        let v = self.0.get_agent_position(agent_no);
        v.map(|v| vec![v.x as f64, v.y as f64])
    }

    #[pi_js_export]
    pub fn get_agent_pref_velocity(&self, agent_no: f64) -> Option<Vec<f64>> {
    ...
    #[pi_js_export]
    pub fn get_agent_velocity(&self, agent_no: f64) -> Option<Vec<f64>> {
    ...
    #[pi_js_export]
    pub fn get_num_agents(&self) -> u32 {
        self.0.get_num_agents() as u32
    }

    #[pi_js_export]
    pub fn get_num_obstacle_vertices(&self) -> u32 {
        self.0.get_num_obstacle_vertices() as u32
    }

    #[pi_js_export]
    pub fn get_obstacle_vertex(&self, vertex_no: f64) -> Option<Vec<f64>> {
    ...
    #[pi_js_export]
    pub fn set_agent_max_neighbors(&mut self, agent_no: f64, max_neighbors: u32) -> bool {
        self.0.set_agent_max_neighbors(agent_no, max_neighbors as usize)
    }
    ...
    #[pi_js_export]
    pub fn get_agent_goal(&mut self, agent_no: f64) -> Option<Vec<f64>> {
    ...
    #[pi_js_export]
    pub fn get_agent_orcaline(&mut self, agent_no: f64, line_no: u32) -> Option<Vec<f64>> {
        let v = self.0.get_agent_orcaline(agent_no, line_no as usize);
        v.map(|v| vec![v.point.x as f64, v.point.y as f64, v.direction.x as f64, v.direction.y as f64])
    }
