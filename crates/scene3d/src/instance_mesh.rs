...
pub fn p3d_instance_mesh(app: &mut Engine, param: &mut ActionSetScene3D, name: &pi_export_base::export::Atom, source: f64) -> f64 {
    ...
    cmds.instancemeshcmds.create.push(OpsInstanceMeshCreation::ops(source, id, name.to_string()));
