...
pub const ACT_SCENE_DISPOSE: u8                 = 002;
pub const ACT_LIGHTING_SHADOW_LIMIT: u8         = 003;
pub const ACT_RENDER_GRAPHIC: u8                = 004;
pub const ACT_ENGINE_STATE: u8                  = 005;
pub const ACT_ENGINE_DEBUG: u8                  = 006;
pub const ACT_CREATE_GLTF_LOAD: u8              = 007;
pub const ACT_CREATE_IMAGE_LOAD: u8             = 008;
pub const ACT_CREATE_RENDER_TARGET: u8          = 009;
pub const ACT_DISPOSE_RENDER_TARGET: u8         = 010;
pub const ACT_SCENE: u8                         = 020;
pub const ACT_SCENE_ANIMATION_ENABLR: u8        = 021;
pub const ACT_SCENE_TIME: u8                    = 022;
pub const ACT_SCENE_FOGCOLOR: u8                = 023;
pub const ACT_SCENE_FOGPARAM: u8                = 024;
pub const ACT_SCENE_AMBIENTCOLOR: u8            = 025;
pub const ACT_SCENE_AMBIENTINTENSITY: u8        = 026;
pub const ACT_LAYERMASK: u8                     = 027;
pub const ACT_SCENE_BRDF_TEXTURE: u8            = 028;
pub const ACT_SCENE_ENV_TEXTURE: u8             = 029;
pub const ACT_SCENE_SHADOWMAP: u8               = 030;
pub const ACT_SCENE_BOUNDINGBOX: u8             = 031;
pub const ACT_COLLIDER: u8                      = 032;
pub const ACT_CREATE_PICKINGRAY: u8             = 033;
pub const ACT_SCENE_PICK: u8                    = 034;
pub const ACT_ANIMATION_GROUP: u8               = 050;
pub const ACT_ANIMATION_CURVE_ID: u8            = 051;
pub const ACT_ANIMATION_GROUP_WEIGHT: u8        = 052;
pub const ACT_ANIMATION_GROUP_TARGET_RESET: u8  = 053;
pub const ACT_ANIMATION_GROUP_START: u8         = 054;
pub const ACT_ANIMATION_GROUP_PAUSE: u8         = 055;
pub const ACT_ANIMATION_GROUP_STOP: u8          = 056;
pub const ACT_ANIMATION_GROUP_GOTO: u8          = 057;
pub const ACT_ANIMATION_GROUP_RESTART: u8       = 058;
pub const ACT_ANIMATION_GROUP_LISTEN: u8        = 059;
pub const ACT_ANIMATION_GROUP_ADD_FRAME_EVENT:u8= 060;
pub const ACT_ANIMATION_GROUP_DELETE: u8        = 061;
pub const ACT_QUERY_ANIMATION_GROUP_EVENTS: u8  = 062;
pub const ACT_QUERY_ANIMATION_CURVE: u8         = 063;
pub const ACT_CREATE_ANIMATION_CURVE: u8        = 064;
pub const ACT_PROPERTY_TARGET_ANIMATION: u8     = 065;
pub const ACT_TRANSFORMNODE: u8                 = 070;
pub const ACT_TRANSFORMNODE_PARENT: u8          = 071;
pub const ACT_TRANSFORMNODE_POSITION: u8        = 072;
pub const ACT_TRANSFORMNODE_SCALING: u8         = 073;
pub const ACT_TRANSFORMNODE_EULER: u8           = 074;
pub const ACT_TRANSFORMNODE_ENABLE: u8          = 075;
pub const ACT_TRANSFORMNODE_QUATERNION: u8      = 076;
pub const ACT_TRAIL: u8                         = 077;
pub const ACT_TRAIL_AGE: u8                     = 078;
pub const ACT_CAMERA: u8                        = 080;
pub const ACT_CAMERA_SIZE: u8                   = 081;
pub const ACT_CAMERA_FOV: u8                    = 082;
pub const ACT_CAMERA_ACTIVE: u8                 = 083;
pub const ACT_CAMERA_MODE: u8                   = 084;
pub const ACT_CAMERA_FIXED_MODE: u8             = 085;
pub const ACT_CAMERA_TARGET: u8                 = 086;
pub const ACT_CAMERA_NEARFAR: u8                = 087;
pub const ACT_CAMERA_ASPECT: u8                 = 088;
pub const ACT_VIEWER_FORCEINCLUDE: u8           = 089;
pub const ACT_CREATE_VERTEX_BUFFER: u8          = 100;
pub const ACT_CREATE_INDICE_BUFFER: u8          = 101;
pub const ACT_CREATE_INDICE_BUFFER32: u8        = 102;
pub const ACT_SPRITE: u8                        = 103;
pub const ACT_SPRITE_FRAME: u8                  = 104;
pub const ACT_SPRITE_FRAME_DATA: u8             = 105;
pub const ACT_SPRITE_FRAME_DATA_RECORD: u8      = 106;
pub const ACT_INSTANCE_MESH: u8                 = 110;
pub const ACT_INSTANCE_VEC4: u8                 = 111;
pub const ACT_INSTANCE_VEC3: u8                 = 112;
pub const ACT_INSTANCE_VEC2: u8                 = 113;
pub const ACT_INSTANCE_FLOAT: u8                = 114;
pub const ACT_INSTANCE_SINT: u8                 = 115;
pub const ACT_INSTANCE_UINT: u8                 = 116;
pub const ACT_INSTANCE_IVEC4: u8                = 117;
pub const ACT_INSTANCE_U16X2: u8                = 118;
pub const ACT_INSTANCE_U16X4: u8                = 119;
pub const ACT_INSTANCE_U8X4: u8                 = 120;
pub const ACT_MESH_BONE_OFFSET: u8              = 121;
pub const ACT_MESH_BONE_OFFSET_ARR: u8          = 122;
pub const ACT_MESH: u8                          = 123;
pub const ACT_MESH_GEOMETRY: u8                 = 124;
pub const ACT_MESH_INDEXRANGE: u8               = 125;
pub const ACT_MESH_MORPHTARGETINFLUENCE: u8     = 126;
pub const ACT_MESH_VERTEXRANGE: u8              = 127;
pub const ACT_MESH_BLEND: u8                    = 128;
pub const ACT_MESH_CULLMODE: u8                 = 129;
pub const ACT_MESH_FRONTFACE: u8                = 130;
pub const ACT_MESH_TOPOLOGY: u8                 = 131;
pub const ACT_MESH_POLYGON_MODE: u8             = 132;
pub const ACT_MESH_CAST_SHADOW: u8              = 133;
pub const ACT_MESH_RECEIVE_SHADOW: u8           = 134;
pub const ACT_MESH_DEPTH_WRITE: u8              = 135;
pub const ACT_MESH_COMPARE: u8                  = 136;
pub const ACT_MESH_BIAS: u8                     = 137;
pub const ACT_MESH_STENCIL_FRONT: u8            = 138;
pub const ACT_MESH_STENCIL_BACK: u8             = 139;
pub const ACT_MESH_STENCIL_WRITE: u8            = 140;
pub const ACT_MESH_STENCIL_READ: u8             = 141;
pub const ACT_MESH_BOUNDING_BOX: u8             = 142;
pub const ACT_MESH_BOUNDING_CULLINGMODE: u8     = 143;
pub const ACT_MESH_RENDER_QUEUE: u8             = 144;
pub const ACT_MESH_RENDER_QUEUE_ARR: u8         = 145;
pub const ACT_MESH_RENDER_ALIGNMENT: u8         = 146;
pub const ACT_MESH_INSTANCE_SORT_MODE: u8       = 147;
pub const ACT_MESH_SCALING_MODE: u8             = 148;
pub const ACT_MESH_VELOCITY: u8                 = 149;
pub const ACT_MESH_VELOCITY_ARR: u8             = 150;
pub const ACT_MESH_ATTRIBUTE_TARGET_ANIM: u8    = 151;
pub const ACT_MESH_POSE_MATRIX: u8              = 152;
pub const ACT_LIGHT: u8                         = 170;
pub const ACT_LIGHT_DIRECTION: u8               = 171;
pub const ACT_LIGHT_STRENGTH: u8                = 172;
pub const ACT_LIGHT_SPOT_ANGLE: u8              = 173;
pub const ACT_LIGHT_RADIUS: u8                  = 174;
pub const ACT_LIGHT_COLOR: u8                   = 175;
pub const ACT_MESH_FORCE_POINT_LIGHT: u8        = 176;
pub const ACT_MESH_FORCE_SPOT_LIGHT: u8         = 177;
pub const ACT_MESH_FORCE_HEMI_LIGHT: u8         = 178;
pub const ACT_MATERIAL: u8                      = 190;
pub const ACT_MATERIAL_SHADER: u8               = 191;
pub const ACT_MATERIAL_APPLY: u8                = 192;
pub const ACT_MATERIAL_UNIFORM_MAT4: u8         = 193;
pub const ACT_MATERIAL_UNIFORM_VEC2: u8         = 194;
pub const ACT_MATERIAL_UNIFORM_VEC4: u8         = 195;
pub const ACT_MATERIAL_UNIFORM_FLOAT: u8        = 196;
pub const ACT_MATERIAL_UNIFORM_UINT: u8         = 197;
pub const ACT_MATERIAL_UNIFORM_TEX: u8          = 198;
pub const ACT_LOAD_TEXTURE: u8                  = 199;
pub const ACT_MATERIAL_TEX_FROM_RENDERTARGET: u8= 200;
pub const ACT_MATERIAL_TEX_FROM_RENDERER: u8    = 201;
pub const ACT_MATERIAL_TARGET_ANIMATION: u8     = 202;
pub const ACT_NODE_MATERIAL_BLOCK_REGIST: u8    = 210;
pub const ACT_MATERIAL_REGIST: u8               = 211;
pub const ACT_PARTICLESYS: u8                   = 220;
pub const ACT_PARTICLESYS_WITH_GLTF: u8         = 221;
pub const ACT_PARTICLESYS_START: u8             = 222;
pub const ACT_PARTICLESYS_TIMESCALE: u8         = 223;
pub const ACT_PARTICLESYS_STOP: u8              = 224;
pub const ACT_RENDER_SUBGRAPH: u8               = 230;
pub const ACT_RENDER: u8                        = 231;
pub const ACT_RENDER_ENABLE: u8                 = 232;
pub const ACT_RENDER_CLEAR_LINK_MESH: u8        = 233;
pub const ACT_RENDER_TARGET_KEY: u8             = 234;
pub const ACT_RENDER_TARGET_AUTO: u8            = 235;
pub const ACT_RENDER_AUTO_CLEAR_COLOR: u8       = 236;
pub const ACT_RENDER_AUTO_CLEAR_DEPTH: u8       = 237;
pub const ACT_RENDER_AUTO_CLEAR_STENCIL: u8     = 238;
pub const ACT_RENDER_CLEAR_COLOR: u8            = 239;
pub const ACT_RENDER_CLEAR_DEPTH: u8            = 240;
pub const ACT_RENDER_CLEAR_STENCIL: u8          = 241;
pub const ACT_RENDER_VIEWPORT: u8               = 242;
pub const ACT_RENDER_LINK_DRAWLIST: u8          = 243;
pub const ACT_RENDER_SCREEN_WITH_POSTPROCESS: u8= 244;
pub const ACT_SHADOW_GENERATOR: u8              = 245;
pub const ACT_SHADOW_BASE_PARAM: u8             = 246;
pub const ACT_SHADOW_FRUSTUM: u8                = 247;
pub const ACT_SKELETON: u8                      = 248;
pub const ACT_BONE: u8                          = 249;
pub const ACT_BONE_LINK: u8                     = 250;
pub const ACT_BONE_POSE: u8                     = 251;
pub const ACT_SKIN_USE: u8                      = 252;